      ...
      {data?.stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            <p className="text-md text-gray-500 font-semibold">Total Tests</p>
            <p className="text-2xl font-medium text-gray-900">{data.stats.totalTests}</p>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            <p className="text-md text-gray-500 font-semibold">Passed</p>
            <p className="text-2xl font-medium text-green-600">{data.stats.passedTests}</p>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            <p className="text-md text-gray-500 font-semibold">Failed</p>
            <p className="text-2xl font-medium text-red-600">{data.stats.failedTests}</p>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            <p className="text-md text-gray-500 font-semibold">Average</p>
            <p className="text-2xl font-medium text-indigo-600">{data.stats.averageScore}%</p>
          </div>
        </div>
      )}
